...
const SampleEditForm = ({ sample, onSave, onCancel }) => {
  ...
  const fields = getMeasurementFields(sample.analysis_type, "en");
      ...
      >
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <Label className="text-base font-semibold text-gray-700">Measurement values</Label>
                  ...
                  <div className="flex items-center flex-wrap gap-x-2 gap-y-1 mt-1">
                    {Object.entries(sample.absorbance_values).map(([wl, val]) => (
                      <div key={wl} className="text-xs font-mono bg-gray-100 px-1.5 py-0.5 rounded">
                          <span className="text-gray-500">{getMeasurementLabel(sample.analysis_type, wl, "en")}:</span>
